...
public OrderForm(Orders ordersPanel, Integer orderId) {
    initComponents();
            ...
            if (rs.next()) {
               ...
               txtCustomer.setText(oldCustomerId + " - " + rsCust.getString("C_name"));
                ...
                for (int i = 0; i < sdata.getItemCount(); i++) {
                    if (sdata.getItemAt(i).startsWith(oldServiceId + " -")) sdata.setSelectedIndex(i);
                }
...
private void loadStatus() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(cust, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 447, -1, 30));

        cphone.setFont(new java.awt.Font("Tahoma", 0, 22)); // NOI18N
        cphone.setText("Service Type :");
        jPanel1.add(cphone, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 520, 150, 40));

        weight.setFont(new java.awt.Font("Tahoma", 0, 22)); // NOI18N
        weight.setText("Weight (kg) :");
        jPanel1.add(weight, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 600, -1, 40));
        ...
        jPanel1.add(saveb, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 770, 128, 56));
        ...
        jPanel1.add(cancelb, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 770, 128, 56));
        ...
        jPanel1.add(ostat, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 670, -1, 40));
        ...
        jPanel1.add(stat, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 680, -1, -1));
        ...
        jPanel1.add(sdata, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 530, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 150, -1, 240));

        txtCustomer.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        jPanel1.add(txtCustomer, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 442, 240, 40));

        jTextField2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel1.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 92, 260, 40));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 91, 110, 40));
        ...
        jPanel1.add(pbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 80, -1, 60));
    ...
    private void savebActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savebActionPerformed
        ...
        try {
            ...
            ordersPanel.dashboard.setVisible(true); 
            this.dispose();
    ...
    int viewRow = jTableCustomers.getSelectedRow();
    if (viewRow < 0) return;

    int row = jTableCustomers.convertRowIndexToModel(viewRow);

    String customerId = jTableCustomers.getModel().getValueAt(row, 0).toString();
    String customerName = jTableCustomers.getModel().getValueAt(row, 1).toString();
