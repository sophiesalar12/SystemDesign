...
public Payment() {
    ...
    model.setColumnIdentifiers(new String[]{
        "Payment ID", "Order ID", "Customer", "Amount Paid", "Payment Date"
    });
...
public void loadPayments() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(Padd, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 100, 40));
        ...
        jPanel1.add(Pupdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 40, 100, 40));

        Pdelete.setBackground(new java.awt.Color(102, 153, 255));
        Pdelete.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        ...
        jPanel1.add(Pdelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 40, 100, 40));
        ...
        jPanel1.add(pbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 30, -1, 60));

        jTextField1.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 40, 240, 41));
        ...
        jPanel1.add(Psearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 40, -1, 41));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, 657, -1));
    ...
    private void PaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PaddActionPerformed
        AdminDashboard dash = (AdminDashboard) javax.swing.SwingUtilities.getWindowAncestor(this);

        dash.setVisible(false);

        Paymentform form = new Paymentform("ADD", -1, dash);
    ...
    private void PupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PupdateActionPerformed
        ...
        Paymentform form = new Paymentform("UPDATE", paymentId, dash);
        form.setVisible(true);
    ...
    private void PdeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PdeleteActionPerformed
        int row = jTable1.getSelectedRow();
        if (row < 0) {
            JOptionPane.showMessageDialog(this, "Select payment to delete");
            return;
        }
    ...
    if (confirm != JOptionPane.YES_OPTION) {
        ...
        try {
            ...
            PreparedStatement pst = conn.prepareStatement(
                "DELETE FROM tbl_payment WHERE P_id=?"
            );
